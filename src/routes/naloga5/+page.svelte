...
<pre>
  <code>// Napiši funkcijo, ki iz seznama besed vrne samo tiste, ki imajo več kot 5 znakov.</code>
</pre>
<hr />
<p class="text-xl">Seznam besed: hiša, avtomobil, miza, programiranje</p>
<p class="text-xl">Filtriran seznam besed: {filtrirajDolgeBesede(seznam)}</p>
